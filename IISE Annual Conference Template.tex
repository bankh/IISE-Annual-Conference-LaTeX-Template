...
\usepackage{hyperref}        % For clickable links in bibliography
...
%%%%% Hyperref Settings %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Configure hyperref to make bibliography links clickable without changing appearance
\hypersetup{
    colorlinks=true,
    linkcolor=black,
    urlcolor=blue,
...
% Set to 1 for final submission (adds author last names in header on pages 2+, hides Abstract ID)
\def\final{0}
\if1\final
    \fancyhead[C]{\textit{No Author Last Names Yet}}  % Replace with author last names
\fi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\if0\blind
% NON-BLIND VERSION: Show title and author information (Abstract ID only for initial submission)
\begin{center}
...
\if1\blind
% BLIND VERSION: Show only title, no authors (Abstract ID only for initial submission)
\begin{center}
{\fontsize{16}{19}\bfseries\selectfont
Paper Title Goes Here: Use 16-Point, Times New Roman, Bold, Centered Font}
