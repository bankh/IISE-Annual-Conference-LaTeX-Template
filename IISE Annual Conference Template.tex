...
%%%%% Title (16pt, bold, centered, Times New Roman) %%%%%%%%%%%%%%%%%%
\begin{center}
...
% Leave space for author names and organizations for final submission
% This space ensures the 6-page limit is not exceeded after acceptance
\vspace{10pt}
...
All papers are limited to 6 pages (including title and author data, references, and figures and tables) and should follow the following format and layout:
...
{\fontsize{12}{14}\bfseries\selectfont References}
